 ...
 */
class RaceLanguage extends \PM\CharacterBundle\Entity\RaceLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\RaceLanguage' . "\0" . 'race', '' . "\0" . 'PM\\CharacterBundle\\Entity\\RaceLanguage' . "\0" . 'language', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RaceLanguage $proxy) {
