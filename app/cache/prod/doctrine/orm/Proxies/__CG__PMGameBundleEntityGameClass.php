 ...
 */
class GameClass extends \PM\GameBundle\Entity\GameClass implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\GameBundle\\Entity\\GameClass' . "\0" . 'game', '' . "\0" . 'PM\\GameBundle\\Entity\\GameClass' . "\0" . 'class', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GameClass $proxy) {
