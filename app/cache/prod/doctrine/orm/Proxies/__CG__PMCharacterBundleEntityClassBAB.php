 ...
 */
class ClassBAB extends \PM\CharacterBundle\Entity\ClassBAB implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassBAB' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassBAB' . "\0" . 'classDnD', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassBAB' . "\0" . 'lvl', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassBAB' . "\0" . 'attackNb', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassBAB' . "\0" . 'value', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassBAB $proxy) {
    ...
    public function setAttackNb($attackNb)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAttackNb', array($attackNb));

        return parent::setAttackNb($attackNb);
    }
    ...
    public function getAttackNb()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAttackNb', array());

        return parent::getAttackNb();
    }
