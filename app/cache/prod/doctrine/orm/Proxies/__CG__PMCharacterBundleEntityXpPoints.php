 ...
 */
class XpPoints extends \PM\CharacterBundle\Entity\XpPoints implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\XpPoints' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\XpPoints' . "\0" . 'characterUsed', '' . "\0" . 'PM\\CharacterBundle\\Entity\\XpPoints' . "\0" . 'increase', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (XpPoints $proxy) {
    ...
    public function setIncrease($increase)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIncrease', array($increase));
    ...
    public function getIncrease()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIncrease', array());
