 ...
 */
class CharacterSkill extends \PM\CharacterBundle\Entity\CharacterSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\CharacterSkill' . "\0" . 'skill', '' . "\0" . 'PM\\CharacterBundle\\Entity\\CharacterSkill' . "\0" . 'characterUsed', '' . "\0" . 'PM\\CharacterBundle\\Entity\\CharacterSkill' . "\0" . 'ranks', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CharacterSkill $proxy) {
