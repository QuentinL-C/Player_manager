 ...
 */
class GameRace extends \PM\GameBundle\Entity\GameRace implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\GameBundle\\Entity\\GameRace' . "\0" . 'game', '' . "\0" . 'PM\\GameBundle\\Entity\\GameRace' . "\0" . 'race', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GameRace $proxy) {
