...
class classDnD extends \PM\CharacterBundle\Entity\classDnD implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\classDnD' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\classDnD' . "\0" . 'name', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
