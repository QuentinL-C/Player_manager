 ...
 */
class Skill extends \PM\CharacterBundle\Entity\Skill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Skill' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Skill' . "\0" . 'name', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
