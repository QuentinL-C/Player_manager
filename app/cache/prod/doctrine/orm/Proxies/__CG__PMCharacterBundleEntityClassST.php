 ...
 */
class ClassST extends \PM\CharacterBundle\Entity\ClassST implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassST' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassST' . "\0" . 'classDnD', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassST' . "\0" . 'lvl', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassST' . "\0" . 'fortitude', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassST' . "\0" . 'reflex', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassST' . "\0" . 'will', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassST $proxy) {
    ...
    public function setFortitude($fortitude)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFortitude', array($fortitude));

        return parent::setFortitude($fortitude);
    }
    ...
    public function getFortitude()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFortitude', array());

        return parent::getFortitude();
    }
    ...
    public function setReflex($reflex)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReflex', array($reflex));

        return parent::setReflex($reflex);
    }
    ...
    public function getReflex()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReflex', array());

        return parent::getReflex();
    }
