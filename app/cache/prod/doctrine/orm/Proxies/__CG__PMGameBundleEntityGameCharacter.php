 ...
 */
class GameCharacter extends \PM\GameBundle\Entity\GameCharacter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\GameBundle\\Entity\\GameCharacter' . "\0" . 'game', '' . "\0" . 'PM\\GameBundle\\Entity\\GameCharacter' . "\0" . 'characterUsed', '' . "\0" . 'PM\\GameBundle\\Entity\\GameCharacter' . "\0" . 'isConnected', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GameCharacter $proxy) {
    ...
    public function setIsConnected($isConnected)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsConnected', array($isConnected));
    ...
    public function getIsConnected()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsConnected', array());
