 ...
 */
class GameGM extends \PM\GameBundle\Entity\GameGM implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\GameBundle\\Entity\\GameGM' . "\0" . 'game', '' . "\0" . 'PM\\GameBundle\\Entity\\GameGM' . "\0" . 'gameMaster', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GameGM $proxy) {
    ...
    public function setGameMaster(\PM\UserBundle\Entity\User $gameMaster)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGameMaster', array($gameMaster));

        return parent::setGameMaster($gameMaster);
    }
    ...
    public function getGameMaster()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGameMaster', array());

        return parent::getGameMaster();
    }
