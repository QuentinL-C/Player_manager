 ...
 */
class CharacterLanguage extends \PM\CharacterBundle\Entity\CharacterLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\CharacterLanguage' . "\0" . 'characterUsed', '' . "\0" . 'PM\\CharacterBundle\\Entity\\CharacterLanguage' . "\0" . 'language', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CharacterLanguage $proxy) {
