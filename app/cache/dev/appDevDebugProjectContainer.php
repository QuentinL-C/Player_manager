...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pm_character.characterusedaction' => 'getPmCharacter_CharacterusedactionService',
            'pm_character.characteruseddnd' => 'getPmCharacter_CharacteruseddndService',
            'pm_character.characterusedskill' => 'getPmCharacter_CharacterusedskillService',
            'pm_character.characterusedst' => 'getPmCharacter_CharacterusedstService',
            'pm_character.deleteability' => 'getPmCharacter_DeleteabilityService',
            ...
            'pm_welcome.connection.listener' => 'getPmWelcome_Connection_ListenerService',
            'pm_welcome.connection.redirect' => 'getPmWelcome_Connection_RedirectService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PMWelcomeBundle', ($this->targetDirs[2].'/Resources/PMWelcomeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PMWelcomeBundle', ($this->targetDirs[3].'/src/PM/WelcomeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PMUserBundle', ($this->targetDirs[2].'/Resources/PMUserBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PMUserBundle', ($this->targetDirs[3].'/src/PM/UserBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PMGameBundle', ($this->targetDirs[2].'/Resources/PMGameBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PMGameBundle', ($this->targetDirs[3].'/src/PM/GameBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'pm_welcome.connection.listener', 1 => 'onKernelRequest'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'player_manager', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/PM/GameBundle/Entity'), 1 => ($this->targetDirs[3].'/src/PM/CharacterBundle/Entity'), 2 => ($this->targetDirs[3].'/src/PM/UserBundle/Entity'), 3 => ($this->targetDirs[3].'/src/PM/WelcomeBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'PM\\GameBundle\\Entity');
        $c->addDriver($b, 'PM\\CharacterBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('PMGameBundle' => 'PM\\GameBundle\\Entity', 'PMCharacterBundle' => 'PM\\CharacterBundle\\Entity', 'PMUserBundle' => 'PM\\UserBundle\\Entity', 'PMWelcomeBundle' => 'PM\\WelcomeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_093c773b5e79af0a75bbfff076b41c83858008f73b68d439eff670f051bdf09e');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('PM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'pm_user_profile', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'pm_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('PM\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'pm_character.characterusedaction' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\CharacterBundle\Service\characterUsedAction A PM\CharacterBundle\Service\characterUsedAction instance.
     */
    protected function getPmCharacter_CharacterusedactionService()
    {
        return $this->services['pm_character.characterusedaction'] = new \PM\CharacterBundle\Service\characterUsedAction($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'));
    }
    ...
    /**
     * Gets the 'pm_character.characterusedskill' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\CharacterBundle\Service\characterUsedSkill A PM\CharacterBundle\Service\characterUsedSkill instance.
     */
    protected function getPmCharacter_CharacterusedskillService()
    {
        return $this->services['pm_character.characterusedskill'] = new \PM\CharacterBundle\Service\characterUsedSkill($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'), $this->get('pm_character.characterusedability'));
    }

    /**
     * Gets the 'pm_character.characterusedst' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\CharacterBundle\Service\characterUsedST A PM\CharacterBundle\Service\characterUsedST instance.
     */
    protected function getPmCharacter_CharacterusedstService()
    {
        return $this->services['pm_character.characterusedst'] = new \PM\CharacterBundle\Service\characterUsedST($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'), $this->get('pm_character.characterusedability'));
    }

    /**
     * Gets the 'pm_character.deleteability' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\CharacterBundle\Service\deleteAbility A PM\CharacterBundle\Service\deleteAbility instance.
     */
    protected function getPmCharacter_DeleteabilityService()
    {
        return $this->services['pm_character.deleteability'] = new \PM\CharacterBundle\Service\deleteAbility($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'));
    }
    ...
    /**
     * Gets the 'pm_character.deletelevel' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\CharacterBundle\Service\deleteLevel A PM\CharacterBundle\Service\deleteLevel instance.
     */
    protected function getPmCharacter_DeletelevelService()
    {
        return $this->services['pm_character.deletelevel'] = new \PM\CharacterBundle\Service\deleteLevel($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \PM\UserBundle\Services\PMUserPasswordGenere A PM\UserBundle\Services\PMUserPasswordGenere instance.
     */
    protected function getPmUser_GenerePasswordService()
    {
        return $this->services['pm_user.genere_password'] = new \PM\UserBundle\Services\PMUserPasswordGenere();
    }

    /**
     * Gets the 'pm_user.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\UserBundle\Form\Type\ProfileFormType A PM\UserBundle\Form\Type\ProfileFormType instance.
     */
    protected function getPmUser_Profile_Form_TypeService()
    {
        return $this->services['pm_user.profile.form.type'] = new \PM\UserBundle\Form\Type\ProfileFormType('PM\\UserBundle\\Entity\\User');
    }

    /**
     * Gets the 'pm_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\UserBundle\Form\Type\RegistrationFormType A PM\UserBundle\Form\Type\RegistrationFormType instance.
     */
    ...
    /**
     * Gets the 'pm_welcome.connection.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\WelcomeBundle\Connection\ConnectionListener A PM\WelcomeBundle\Connection\ConnectionListener instance.
     */
    protected function getPmWelcome_Connection_ListenerService()
    {
        return $this->services['pm_welcome.connection.listener'] = new \PM\WelcomeBundle\Connection\ConnectionListener($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'), $this->get('pm_welcome.connection.redirect'));
    }

    /**
     * Gets the 'pm_welcome.connection.redirect' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PM\WelcomeBundle\Connection\ConnectionRedirect A PM\WelcomeBundle\Connection\ConnectionRedirect instance.
     */
    protected function getPmWelcome_Connection_RedirectService()
    {
        return $this->services['pm_welcome.connection.redirect'] = new \PM\WelcomeBundle\Connection\ConnectionRedirect($this->get('router'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('PM\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'PMWelcomeBundle', 1 => 'PMUserBundle', 2 => 'PMGameBundle', 3 => 'PMCharacterBundle', 4 => 'FOSUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PM/GameBundle/Resources/views'), 'PMGame');
        $instance->addPath(($this->targetDirs[3].'/src/PM/CharacterBundle/Resources/views'), 'PMCharacter');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PMGameBundle' => 'PM\\GameBundle\\PMGameBundle',
                'PMCharacterBundle' => 'PM\\CharacterBundle\\PMCharacterBundle',
            ...
            'fos_user.profile.form.type' => 'pm_user_profile',
            ...
            'fos_user.registration.form.type' => 'pm_user_registration',
