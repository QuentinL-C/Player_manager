$(document).ready(function() {
    ...
    var $container = $('div#pm_characterbundle_characterused_addskill_skills'); //-> Changer div en table pour mettre en place le theme
                     $('div#pm_characterbundle_characterused_addskill_skills').prev().hide();
        ...
        $new_container = '\n\
            ...
            <div class="col-md-9">\n\
                <div class="row">\n\
                    ...
                    <div class="col-md-4">\n\
                        <input id="pm_characterbundle_characterused_register_classDnDInstances_' + index + '_level" type="number" required="required" class="form-control" name="pm_characterbundle_characterused_register[classDnDInstances][' + index + '][level]"></input>\n\
                    </div>\n\
                </div>\n\
            </div>';
