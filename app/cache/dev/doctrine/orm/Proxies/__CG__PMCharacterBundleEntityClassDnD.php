 ...
 */
class ClassDnD extends \PM\CharacterBundle\Entity\ClassDnD implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'name', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'description', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'slug', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'babs', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'skills', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassDnD $proxy) {
    ...
    public function addBab(\PM\CharacterBundle\Entity\ClassBAB $bab)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBab', array($bab));

        return parent::addBab($bab);
    }
    ...
    public function removeBab(\PM\CharacterBundle\Entity\ClassBAB $bab)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBab', array($bab));

        return parent::removeBab($bab);
    }
    ...
    public function getBabs()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBabs', array());

        return parent::getBabs();
    }
