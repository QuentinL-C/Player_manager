...
class ClassDnD extends \PM\CharacterBundle\Entity\ClassDnD implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'name', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'description', '' . "\0" . 'PM\\CharacterBundle\\Entity\\ClassDnD' . "\0" . 'slug', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
