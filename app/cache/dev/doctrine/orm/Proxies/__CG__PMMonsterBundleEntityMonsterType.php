 ...
 */
class MonsterType extends \PM\MonsterBundle\Entity\MonsterType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\MonsterBundle\\Entity\\MonsterType' . "\0" . 'id', '' . "\0" . 'PM\\MonsterBundle\\Entity\\MonsterType' . "\0" . 'name', '' . "\0" . 'PM\\MonsterBundle\\Entity\\MonsterType' . "\0" . 'slug', '' . "\0" . 'PM\\MonsterBundle\\Entity\\MonsterType' . "\0" . 'description', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MonsterType $proxy) {
