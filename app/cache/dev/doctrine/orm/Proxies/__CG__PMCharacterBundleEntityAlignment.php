 ...
 */
class Alignment extends \PM\CharacterBundle\Entity\Alignment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Alignment' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Alignment' . "\0" . 'name', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Alignment' . "\0" . 'description', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Alignment' . "\0" . 'slug', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Alignment $proxy) {
