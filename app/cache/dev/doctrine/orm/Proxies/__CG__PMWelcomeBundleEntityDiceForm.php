 ...
 */
class DiceForm extends \PM\WelcomeBundle\Entity\DiceForm implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\WelcomeBundle\\Entity\\DiceForm' . "\0" . 'id', '' . "\0" . 'PM\\WelcomeBundle\\Entity\\DiceForm' . "\0" . 'diceEntities', '' . "\0" . 'PM\\WelcomeBundle\\Entity\\DiceForm' . "\0" . 'bonusNumbers', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DiceForm $proxy) {
    ...
    public function addDiceEntity(\PM\WelcomeBundle\Entity\DiceEntity $diceEntity)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addDiceEntity', array($diceEntity));

        return parent::addDiceEntity($diceEntity);
    }
    ...
    public function getDiceEntities()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDiceEntities', array());

        return parent::getDiceEntities();
    }
    ...
    public function removeDiceEntity(\PM\WelcomeBundle\Entity\DiceEntity $diceEntity)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeDiceEntity', array($diceEntity));

        return parent::removeDiceEntity($diceEntity);
    }
    ...
    public function addBonusNumber(\PM\WelcomeBundle\Entity\BonusNumber $bonusNumber)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBonusNumber', array($bonusNumber));

        return parent::addBonusNumber($bonusNumber);
    }
    ...
    public function getBonusNumbers()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBonusNumbers', array());

        return parent::getBonusNumbers();
    }
    ...
    public function removeBonusNumber(\PM\WelcomeBundle\Entity\BonusNumber $bonusNumber)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBonusNumber', array($bonusNumber));

        return parent::removeBonusNumber($bonusNumber);
    }
