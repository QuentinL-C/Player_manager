 ...
 */
class Level extends \PM\CharacterBundle\Entity\Level implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Level' . "\0" . 'id', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Level' . "\0" . 'level', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Level' . "\0" . 'xpPoints', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Level' . "\0" . 'classSkillModifier', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Level' . "\0" . 'ofClassSkillModifier', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Level' . "\0" . 'gift', '' . "\0" . 'PM\\CharacterBundle\\Entity\\Level' . "\0" . 'abilityUp', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
    ...
    public function setXpPoints($xpPoints)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setXpPoints', array($xpPoints));

        return parent::setXpPoints($xpPoints);
    }
    ...
    public function getXpPoints()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getXpPoints', array());

        return parent::getXpPoints();
    }
    ...
    public function setClassSkillModifier($classSkillModifier)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClassSkillModifier', array($classSkillModifier));

        return parent::setClassSkillModifier($classSkillModifier);
    }
    ...
    public function getClassSkillModifier()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getClassSkillModifier', array());

        return parent::getClassSkillModifier();
    }
    ...
    public function setOfClassSkillModifier($ofClassSkillModifier)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOfClassSkillModifier', array($ofClassSkillModifier));

        return parent::setOfClassSkillModifier($ofClassSkillModifier);
    }
    ...
    public function getOfClassSkillModifier()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOfClassSkillModifier', array());

        return parent::getOfClassSkillModifier();
    }
    ...
    public function setAbilityUp($abilityUp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAbilityUp', array($abilityUp));

        return parent::setAbilityUp($abilityUp);
    }
    ...
    public function getAbilityUp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAbilityUp', array());

        return parent::getAbilityUp();
    }
