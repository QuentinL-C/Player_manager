...
namespace Proxies\__CG__\PM\WeaponBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class WeaponType extends \PM\WeaponBundle\Entity\WeaponType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PM\\WeaponBundle\\Entity\\WeaponType' . "\0" . 'id', '' . "\0" . 'PM\\WeaponBundle\\Entity\\WeaponType' . "\0" . 'name', '' . "\0" . 'PM\\WeaponBundle\\Entity\\WeaponType' . "\0" . 'slug', '' . "\0" . 'PM\\WeaponBundle\\Entity\\WeaponType' . "\0" . 'description', 'createUser', 'createDate', 'updateUser', 'updateDate', 'updateComment');
        }
