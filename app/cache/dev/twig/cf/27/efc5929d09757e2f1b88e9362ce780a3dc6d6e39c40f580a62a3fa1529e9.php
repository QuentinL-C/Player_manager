...
";
    ...
    <section id=\"content\" class=\"col-lg-12\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["race"]) {
            ...
            // line 35
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("pm_race_view", array("slug" => $this->getAttribute($context["race"], "slug", array()))), "html", null, true);
            echo "\">";
