...
/* PMCharacterBundle:Alignment:edit_content.html.twig */
class __TwigTemplate_b85c0e88dc5072c95baa155ab1c6e3a9772ce775b166683c82fcd5807eb13c84 extends Twig_Template
{
...
<form class=\"form-horizontal\" method=\"post\" action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("pm_alignment_edit", array("slug" => $this->getAttribute((isset($context["alignment"]) ? $context["alignment"] : $this->getContext($context, "alignment")), "slug", array()))), "html", null, true);
        echo "\" ";
    ...
    <fieldset>
        ...
        echo "
            <div class=\"col-md-9\">
                ";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "name", array()), 'widget', array("attr" => array("placeholder" => "Nom de votre alignement", "class" => "form-control")));
        echo "
            </div>
        </div>
        ...
        <div class=\"form-group\">
            <div class=\"col-md-3 control-label\">
                <span class=\"glyphicon glyphicon-question-sign\" style=\"cursor: pointer;\" data-content=\"La description de votre alignement sera utilisée comme texte descriptif de ce dernier sur sa page publique, accessible à tous.\" data-toggle=\"popover\" data-container=\"body\" data-original-title=\"Description\" ></span>
                ";
        // line 28
    ...
    {
        return "PMCharacterBundle:Alignment:edit_content.html.twig";
    }
