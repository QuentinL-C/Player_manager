...
";
    ...
    <a class=\"btn btn-lg btn-danger main-JS-delete\" href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("pm_size_administration_delete", array("slug" => $this->getAttribute((isset($context["size"]) ? $context["size"] : $this->getContext($context, "size")), "slug", array()))), "html", null, true);
        echo "\" >Supprimer</a>
";
    }
