...
<form action=\"";
    ...
    <fieldset>
        ...
        <div class=\"form-group main-hide-div\">
            ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "current_password", array()), 'label', array("label_attr" => array("class" => "col-sm-4 control-label"), "label" => "Mot de passe :"));
        echo "
            <div class=\"col-sm-8\">
                ";
        // line 47
        ...
        <div class=\"form-group\">
            ";
        // line 52
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "phone", array()), 'label', array("label_attr" => array("class" => "col-sm-4 control-label"), "label" => "Téléphone :"));
        echo "
            <div class=\"col-sm-2\">
                ";
        // line 54
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "phone", array()), 'widget', array("attr" => array("placeholder" => "Format: 0601020304", "class" => "form-control")));
        echo "
            </div>
        </div>
    </fieldset>
    ...
    <fieldset class=\"col-md-offset-1 col-md-5\">
        ...
        <dl class=\"dl-horizontal\">
            <dt>Mot de Passe :</dt>
            <dd><a href=\"\" class=\"btn btn-primary\">Modifier</a></dd>
        </dl>
    </fieldset>
        <br />
    ";
    ...
    {
        return array (  148 => 68,  131 => 54,  126 => 52,  118 => 47,  113 => 45,  105 => 40,  100 => 38,  92 => 33,  87 => 31,  79 => 26,  73 => 23,  68 => 21,  61 => 16,  54 => 12,  50 => 11,  46 => 10,  42 => 9,  38 => 8,  34 => 7,  30 => 5,  28 => 4,  22 => 3,  19 => 2,);
    }
}
