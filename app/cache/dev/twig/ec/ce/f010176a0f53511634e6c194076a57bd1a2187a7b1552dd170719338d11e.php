...
";
    ...
    <a class=\"btn btn-lg btn-danger main-JS-delete\" href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("pm_skill_administration_delete", array("slug" => $this->getAttribute((isset($context["skill"]) ? $context["skill"] : $this->getContext($context, "skill")), "slug", array()))), "html", null, true);
        echo "\" >Supprimer</a>
";
    }
