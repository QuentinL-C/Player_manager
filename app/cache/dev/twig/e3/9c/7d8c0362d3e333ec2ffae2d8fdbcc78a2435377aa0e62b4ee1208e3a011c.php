...
/* PMGameBundle:Game:listGames.html.twig */
class __TwigTemplate_e39c7d8c0362d3e333ec2ffae2d8fdbcc78a2435377aa0e62b4ee1208e3a011c extends Twig_Template
{
...
";
    ...
    <section id=\"content\" class=\"col-lg-12\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["game"]) {
            ...
            // line 35
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("pm_game_administration_view", array("slug" => $this->getAttribute($context["game"], "slug", array()))), "html", null, true);
            echo "\">";
        ...
        if (!$context['_iterated']) {
            // line 38
            echo "                <tr>
                    <td colspan=\"5\" style=\"text-align: center; font-weight: bold;\">Aucune partie connu.</td>
                </tr>
            ";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return "PMGameBundle:Game:listGames.html.twig";
    }
