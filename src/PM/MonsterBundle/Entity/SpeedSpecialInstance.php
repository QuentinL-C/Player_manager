 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="PM\MonsterBundle\Entity\SpeedSpecialInstanceRepository")
 */
class SpeedSpecialInstance
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="PM\MonsterBundle\Entity\SpeedSpecial")
     ...
     * Set speedSpecial
     *
     * @param \stdClass $speedSpecial
     * @return SpeedSpecialInstance
     */
    public function setSpeedSpecial($speedSpecial)
    {
